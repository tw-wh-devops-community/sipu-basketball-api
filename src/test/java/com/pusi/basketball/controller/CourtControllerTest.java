...
class CourtControllerTest {
    ...
    public void should_response_all_courts() {
        ...
        doReturn(true).when(validatorService).validateGetCourtsRequestParam(mockDate, mockStartTime, mockEndTime);
    ...
    public void should_response_bad_request_when_date_query_param_is_not_valid() {
        ...
        Integer mockStartTime = 9;
        Integer mockEndTime = 12;
        doReturn(false).when(validatorService).validateGetCourtsRequestParam(mockDate, mockStartTime, mockEndTime);
